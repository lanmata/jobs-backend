...
```
cd existing_repo
git remote add origin https://gitlab.com/jobs-board/jobs-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/jobs-board/jobs-backend/-/settings/integrations)
